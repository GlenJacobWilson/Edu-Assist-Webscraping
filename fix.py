...
def get_ktu_announcements():
    ...
    try:
        ...
        if response.status_code in (400, 401, 403):
            print(f"[Scraper] Token expired ({{response.status_code}}). Paste a new x-Token in scraper.py")
            return []
...
if __name__ == "__main__":
    ...
    if results:
        ...
        print("No results — update x-Token in scraper.py")
'''

with open("scraper.py", "w", encoding="utf-8") as f:
    f.write(content)
print("scraper.py written successfully with UTF-8 encoding")